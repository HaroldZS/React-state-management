...
import { reducerIf } from "@/reducers/reducerIf";
...
function SecurityFormRI({ repository }: { repository: string }) {
  const modalRef = useRef<HTMLDialogElement>(null);
  const [state, dispatch] = useReducer(reducerIf, initialState);
